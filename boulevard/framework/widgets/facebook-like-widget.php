...
class Facebook_Like_Widget extends WP_Widget {
	...
	function Facebook_Like_Widget()
	{
		...
		$this->WP_Widget('facebook-like-widget', 'Boulevard: Facebook Like Box', $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => 'Find us on Facebook', 'page_url' => '', 'width' => '292', 'height' => '270', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
