...
define( 'NOTIFIER_THEME_NAME', 'Boulevard' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'Boulevard' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://boulevard.themesector.com/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
